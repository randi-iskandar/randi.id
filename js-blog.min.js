...
// Ctrl u
var _0x4300=["onkeydown","ctrlKey","keyCode","Template oleh RANDI.ID","Mod dari VioMagz","Terima kasih Mas Sugeng."];document[_0x4300[0]]=function(n){if(n[_0x4300[1]]&&85===n[_0x4300[2]]){if(1!=confirm(_0x4300[3]))return alert(_0x4300[5]),!1;alert(_0x4300[4])}};
// console
console.log('%cTemplate dikembangkan oleh fb.com/randidotid \Temukan saya di Facebook.', 'font:2.5em Roboto;color:#ff0000')
/* Oleh - https://www.randi.id */